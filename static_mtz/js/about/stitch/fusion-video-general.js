function insertParam(e,t,i,o){
    var u,a,r,s,n,d,y;
    if(0<e.indexOf("#")?(u=e.indexOf("#"),a=e.substring(e.indexOf("#"),e.length)):(a="",u=e.length),
    s="",1<(r=e.substring(0,u).split("?")).length)
    for(n=r[1].split("&"),d=0; d<n.length;d++)
        (y=n[d].split("="))
        [0]!==t&&(""===s?s="?"+y[0]+"="+(y[1]?y[1]:""):(s+="&",s+=y[0]+"="+(y[1]?y[1]:"")));
        return""===s&&(s="?"),
        o?s="?"+t+"="+i+(1<s.length?"&"+s.substring(1):""):(""!==s&&"?"!==s&&(s+="&"),s+=t+"="+(i||"")),
        r[0]+s+a
}
function registerYoutubePlayers(e){
    Number(fusionVideoGeneralVars.status_yt)&&!0===window.yt_vid_exists&&(window.$youtube_players=[],
        jQuery(".tfs-slider").each(function(){
            var t=jQuery(this),i=t.find("[data-youtube-video-id]").find("iframe").length,o=!1;
...
function loadYoutubeIframeAPI(){
    var e,t;
    Number(fusionVideoGeneralVars.status_yt)&&(!0===window.yt_vid_exists||jQuery("body").hasClass("fusion-builder-live"))&&((e=document.createElement("script")).src="https://www.youtube.com/iframe_api",
...
function onPlayerStateChange(e,t){
    return function(e){
        ...
        e.data==YT.PlayerState.ENDED&&"1"==jQuery(t).data("autoplay")&&(void 0!==jQuery(t).find(".flex-active-slide").data("loop")&&"yes"!==jQuery(t).find(".flex-active-slide").data("loop")&&jQuery(t).flexslider("next"),jQuery(t).flexslider("play"))
    }
}
...
function playVideoAndPauseOthers(e){
    var t=jQuery(e).find("[data-youtube-video-id]").find("iframe"),i=jQuery(e).data("flexslider").slides.eq(jQuery(e).data("flexslider").currentSlide),
    ...
    "yes"===i.attr("data-mute")&&void 0!==window.$youtube_players[o.attr("id")]&&void 0!==window.$youtube_players[o.attr("id")].mute&&window.$youtube_players[o.attr("id")].mute()),
...
function fusionYouTubeTimeout(e){
    void 0===fusionTimeout[e]&&(fusionTimeout[e]=0),setTimeout(function(){
        void 0!==window.$youtube_players&&void 0!==window.$youtube_players[e]&&void 0!==window.$youtube_players[e].playVideo?window.$youtube_players[e].playVideo():++fusionTimeout[e]<5&&fusionYouTubeTimeout(e)
    },
    325)
}
