...
function setUserResponse(val) {
	...
	var UserResponse = '<img class="userAvatar" src=' + "userAvatar.jpg" + '><p class="userMsg">' + val + ' </p><div class="clearfix"></div>';
...
function setBotResponse(val) {
	setTimeout(function () {
		if (val.length < 1) {
			...
			var BotResponse = '<img class="botAvatar" src="botAvatar.png"><p class="botMsg">' + msg + '</p><div class="clearfix"></div>';
