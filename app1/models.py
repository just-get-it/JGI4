...
class diet_detail(models.Model):
    ...
    type= models.CharField(max_length=30, null=True, blank=True)
    regio= models.CharField(max_length=30, null=True, blank=True)
    t_periods= models.CharField(max_length=30, null=True, blank=True)
...
class Nutrition_item(models.Model):
    ...
    # Vit_D = modye dosti tere dam se haiels.FloatField(null=True, blank=True,default=0)
